...
#print finalTable
metaInfoHtml = '%s%s%s' % ('<!DOCTYPE html><html><head><link rel="stylesheet" type="text/css" href="/view/All/job/postman/ws/src/css/table.css"></head><body><h2>Postman Harness Report</h2><p>Execution Time :</p><p>@ <strong>',localtime,'</strong></p><div style="overflow-x:auto;">')
